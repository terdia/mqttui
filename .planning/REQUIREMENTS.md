...
- [ ] **FOUND-01**: Application uses Flask application factory pattern with blueprints replacing monolithic app.py
- [ ] **FOUND-02**: Eventlet replaced with gevent for async mode; Python 3.11+ base image
- [ ] **FOUND-03**: paho-mqtt upgraded to 2.x with CallbackAPIVersion.VERSION2 callbacks
- [ ] **FOUND-04**: Flask upgraded to 3.1.x with compatible Werkzeug version
- [ ] **FOUND-05**: SQLite uses WAL mode with busy_timeout on all connections
...
- [ ] **RULE-05**: User can enable/disable individual rules without deleting them
